...
msg_info "Scaling Container to Normal Resources (build needed ${var_ram}MB, runtime doesn't)"
$STD pct set "$CTID" -memory 2048
msg_ok "Scaled Container to Normal Resources"
